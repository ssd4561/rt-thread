...
/**
 * @name: FGmac_DMATxDescChainInit
 * @msg:
 * @param {Ft_Gmac_t} *Gmac
 * @param {FGmac_DmaDesc_t} *DMATxDescTab
 * @param {u8} *TxBuff
...
/**
 * @name: Ft_Gmac_DMATxDescRingInit
 * @msg:
 * @param {Ft_Gmac_t} *Gmac
 * @param {FGmac_DmaDesc_t} *DMATxDescTab
 * @param {u8} *TxBuff
 ...
 * @msg:
 * @param {Ft_Gmac_t} *Gmac
 * @param {FGmac_DmaDesc_t} *DMARxDescTab
 * @param {u8} *RxBuff
...
/**
 * @name: Gmac_GetReceivedFrame_IT
 * @msg:  Gets the received frame in interrupt mode.
 * @param {Ft_Gmac_t} *Gmac
 * @return {*}
 */
// static s32 FGmac_chainGetReceivedFrame_IT(Ft_Gmac_t *Gmac)
// {
//     u32 DescriptorsCounter = 0U;
//     GMAC_DESC_DEBUG_I(" Gmac->RxDesc->Status %x \r\n", Gmac->RxDesc->Status);
//     while (((Gmac->RxDesc->Status & DMA_RDES0_OWN) == 0) && DescriptorsCounter < RX_DESCNUM)
//     {
//         DescriptorsCounter++;
//         /* Check if first segment in frame */
//         if ((Gmac->RxDesc->Status & (DMA_RDES0_FIRST_DESCRIPTOR | DMA_RDES0_LAST_DESCRIPTOR)) == (u32)DMA_RDES0_FIRST_DESCRIPTOR)
//         {
...
//         else if ((Gmac->RxDesc->Status & (DMA_RDES0_FIRST_DESCRIPTOR | DMA_RDES0_LAST_DESCRIPTOR)) == 0)
//         {
...
//             Gmac->DMARxFrameInfos.length = ((Gmac->RxDesc->Status & DMA_RDES0_FRAME_LEN_MASK) >> 16U);

//             /* Get address of the buffer start address  */
...
/**
 * @name: FGmac_GetReceivedFrame
 * @msg:  Check for received frames.
 * @param {Ft_Gmac_t} *Gmac
 * @return {*}
 */
