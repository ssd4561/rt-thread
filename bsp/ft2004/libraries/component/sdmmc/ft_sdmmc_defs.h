...
 *
 * @Date: 2021-04-08 11:50:06
 * @LastEditTime: 2021-04-13 10:50:52
 * @Description:  This files is for sdmmc cmd definition
 *
 * @Modify History:
 *  Ver   Who        Date         Changes
 * ----- ------     --------    --------------------------------------
 * 0.2.0 Zhu Gengyu  2021/4/8    init
 */

#ifndef _FT_SDMMC_DEFS_H_
#define _FT_SDMMC_DEFS_H_
 ...
 */
        static inline u32 MMC_RSP_BITS(u32 *src, int start, int len)
        {
                u32 mask = (len % 32 == 0) ? UINT_MAX : UINT_MAX >> (32 - (len % 32));
                size_t word = start / 32;
                size_t shift = start % 32;
                u32 right = src[word] >> shift;
                u32 left = (len + shift <= 32) ? 0 : src[word + 1] << ((32 - shift) % 32);
...
//#define CONFIG_FREERTOS_HZ                              100 /* NOT SURE ABOUT THE VALUE */
//#define configTICK_RATE_HZ                ( CONFIG_FREERTOS_HZ )
//#define portTICK_PERIOD_MS            ( ( u32 ) 1000 / configTICK_RATE_HZ )
